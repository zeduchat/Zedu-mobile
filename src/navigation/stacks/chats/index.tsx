...
export const ChatStack = () => (
    ...
    >
        ...
        <Stack.Screen name="GroupAddNewMembers" component={GroupAddNewMembersScreen} />
        <Stack.Screen name="AddMemberScreen" component={AddMemberScreen} />
        <Stack.Screen name="GroupChatThreadScreen" component={GroupChatThreadScreen} />
        ...
        <Stack.Screen name="GroupUserDetailScreen" component={GroupUserDetailScreen} />
