                ...
                >
                    ...
                    <View style={styles.previewSection}>
                        <View style={styles.previewCard}>
                            ...
                            <View style={styles.videoPreviewContainer}>
                                {showVideo ? (
                                    ...
                                    <View style={styles.avatarContainer}>
                                        {avatarUrl ? (
                                            <FastImage source={{ uri: avatarUrl }} style={styles.avatarImage} />
                                        ) : (
                            ...
                            <View style={styles.deviceControlsRow}>
                                <TouchableOpacity
                                    style={[styles.deviceControl, isMuted && styles.deviceControlActive]}
                                    onPress={onToggleMic}
                                    activeOpacity={0.7}
                                >
                                    <Ionicons
                                ...
                                <TouchableOpacity
                                    style={[styles.deviceControl, !showVideo && styles.deviceControlActive]}
                    ...
                    <View style={styles.ctaSection}>
                        <View style={styles.ctaRow}>
                            <Animated.View style={[styles.ctaButtonWrap, { transform: [{ scale: pulseAnim }] }]}>
                                <TouchableOpacity
                                ...
                                >
                                    <View style={styles.joinButtonGradient}>
                                        <MaterialCommunityIcons name="video-plus" size={24} color={Colors.white} />
