            ...
            <View style={styles.messageRow}>
                <View style={styles.avatarContainer}>
                    {item.user.avatar ? (
                        ...
                        <View style={styles.avatarPlaceholder}>
                            <AppText variant="bold" style={styles.avatarInitial}>{item.user.name.charAt(0)}</AppText>
                        </View>
                    )}
                </View>
                ...
                <View style={styles.messageContent}>
                    <View style={styles.messageHeader}>
                        <AppText variant="bold" style={styles.senderName}>{isMe ? 'You' : item.user.name}</AppText>
        ...
        >
            <View style={styles.container}>
                <View style={styles.header}>
                    <View>
                        <AppText variant="bold" style={styles.headerTitle}>In-meeting Chat</AppText>
                        <AppText style={styles.headerSub}>Visible to everyone in the call</AppText>
                    </View>
                    ...
                    <View style={styles.inputWrapper}>
                        {typingUsers.length > 0 && (
                            <View style={styles.typingIndicator}>
                                <ActivityIndicator size="small" color="#616061" style={{ transform: [{ scale: 0.6 }] }} />
                                <AppText style={styles.typingText}>{typingUsers[0]} is typing...</AppText>
                            </View>
                        )}
                            ...
                            <View style={styles.replyingBar}>
                                <View style={styles.replyingBarContent}>
                                    ...
                                    <AppText style={styles.replyingToText} numberOfLines={1}>
                                        Replying to <AppText variant="bold">{replyTo.user.name}</AppText>
                                    </AppText>
                                </View>
                        ...
                        <View style={styles.inputBox}>
                            ...
                            <View style={styles.inputActions}>
                                <TouchableOpacity style={styles.attachmentIcon} onPress={() => setShowEmoji(v => !v)}>
                                    <Ionicons name="happy-outline" size={20} color="#616061" />
                                </TouchableOpacity>
                                <TouchableOpacity
                                    style={[styles.sendCircle, !input.trim() && { backgroundColor: '#F8F8F8' }]}
                                    onPress={handleSend}
                                    disabled={!input.trim()}
                                >
                                    <Ionicons
