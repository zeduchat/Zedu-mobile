...
const AvatarSheet = forwardRef<AppBottomSheetRef, AvatarSheetProps>(({ onSelect, selectedAvatar }, ref) => {
    const FastImageSize = (width - (HORIZONTAL_PADDING * 2) - (GAP * (COLUMN_COUNT - 1))) / COLUMN_COUNT;
    ...
    return (
        ...
        >
            <View style={styles.sheetHeader}>
                <AppText variant="bold" size={18}>Choose Avatar</AppText>
            </View>
                    ...
                    renderItem={({ item }) => {
                        ...
                        return (
                            ...
                            >
                                <FastImage
                                    source={{uri:item.url}}
                                    style={{ width: '100%', height: '100%', borderRadius: FastImageSize / 2 }}
                                />
                            </TouchableOpacity>
                        );
                    }}
