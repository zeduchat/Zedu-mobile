                ...
                <View>
                    <View style={styles.senderRow}>
                        <AppText
                            ...
                            variant="bold"
                            numberOfLines={1}
                            style={[styles.senderNameLabel, { color: item.senderColor, flex: 1, minWidth: 0, marginRight: 4 }]}
                        >
                            {truncateUsernameForChannel(item.username)}
                        </AppText>
                        <AppText size={10} style={styles.timeText}>{item.time}</AppText>
                    </View>
...
const styles = StyleSheet.create({
    rowContainer: { flexDirection: 'row', alignItems: 'flex-start', paddingLeft: 15, paddingTop: 20, paddingBottom: 20, borderBottomWidth: 1, borderColor: Colors.border, borderLeftWidth: 3, borderLeftColor: Colors.primary, backgroundColor: '#F5F5F5', marginHorizontal: 10, borderRadius: 8 },
    groupAvatarContainer: { marginRight: 5 },
    threadStatusIcon: { marginRight: 4, alignSelf: 'center' },
    groupSenderAvatar: { width: 35, height: 35, borderRadius: 50, borderWidth: 2, borderColor: Colors.primary },
