...
export const AudioMessagePlayer = ({ audioUrl, item, media }: AudioMessagePlayerProps) => {
    ...
    const playbackEngine = useMemo(() => getVoicePlaybackEngine(voiceMedia), [voiceMedia]);
    ...
    const timeLabel = isPlaying
        ...
        : durationMs > 0 ? formatTime(durationMs) : '0:00';
    ...
    return (
        <View style={styles.container}>
            ...
            <TouchableOpacity style={styles.playBtn} onPress={handlePlayPause} activeOpacity={0.8} disabled={isLoading}>
                {isLoading
            ...
            <View style={styles.middle}>
                ...
                <AppText size={10} style={styles.timer}>{timeLabel}</AppText>
            </View>
            ...
            {(item?.avatar_url || item?.default_avatar_url) &&
                <View style={styles.avatarWrap}>
                    ...
                    <View style={[styles.micBadge, { backgroundColor: isPlaying ? Colors.primary : '#8696A0' }]}>
...
const styles = StyleSheet.create({
    ...
    waveformRow: { flexDirection: 'row', alignItems: 'center', gap: 2, height: 28 },
    bar: { flex: 1 },
