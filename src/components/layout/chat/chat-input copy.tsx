    ...
    return (
        <View style={styles.inputContainer}>
            ...
            {message.length === 0 ? (
                ...
                <TouchableOpacity style={styles.sendBtn} onPress={() => onSend(message, 'text')}>
...
const styles = StyleSheet.create({
    inputContainer: { flexDirection: 'row', alignItems: 'center', padding: 8, paddingVertical: 20, backgroundColor: Colors.topNavigation },
    textInputWrapper: { flex: 1, flexDirection: 'row', backgroundColor: Colors.white, borderRadius: 25, marginHorizontal: 8, paddingHorizontal: 12, alignItems: 'center' },
    input: { flex: 1, paddingVertical: 8, maxHeight: 100, fontSize: 16 },
    iconBtn: { padding: 8 },
    inputIcon: { width: 24, height: 24, tintColor: '#54656F' },
    emojiBtn: { padding: 4 },
    rightIcons: { flexDirection: 'row', alignItems: 'center' },
    sendBtn: { width: 40, height: 40, borderRadius: 22, backgroundColor: Colors.primary, justifyContent: 'center', alignItems: 'center' },
