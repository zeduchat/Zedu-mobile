    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                <AppText variant="bold" size={14}>Mention someone</AppText>
                ...
                {filteredParticipants.length > 0 ? (
                        ...
                        >
                            <View style={styles.avatarContainer}>
                                <Image
                                    ...
                                    style={styles.avatar}
                                />
                                <View style={item.online ? styles.onlineBadge : styles.offlineBadge} />
                            </View>
                    ...
                    <View style={styles.emptyContainer}>
                        <AppText style={styles.emptyText}>
                            {participants.length === 0 ? 'No members available' : 'No matches found'}
                        </AppText>
                    </View>
                )}
            </ScrollView>
