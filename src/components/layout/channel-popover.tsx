                ...
                <>
                    ...
                    <Animated.View style={[styles.popoverCard, {
                        ...
                        <TouchableOpacity style={styles.menuItem} onPress={createChannel}>
                            ...
                            <AppText variant="medium" size={15} style={styles.menuText}>Create Channel</AppText>
                        </TouchableOpacity>
                        ...
                        <TouchableOpacity style={styles.menuItem} onPress={browse}>
                            ...
                            <AppText variant="medium" size={15} style={styles.menuText}>Browse Channels</AppText>
                        </TouchableOpacity>
                    </Animated.View>
                </>
            )}
