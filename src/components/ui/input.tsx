    ...
    return (
        <View style={[styles.container, style]}>
            ...
            <View style={[
                ...
                multiline && { height: 'auto', minHeight: normalize(100), alignItems: 'flex-start', paddingTop: normalize(10) }
            ]}>
                <TextInput
                ...
                />
                {secureTextEntry && (
                    <TouchableOpacity onPress={() => setIsPasswordVisible(!isPasswordVisible)} disabled={disabled}>
