...
const NotificationPreferenceScreen: React.FC<NotificationPreferenceModalProps> = ({
    channelId,
    channelName = "Default"
}) => {
    ...
    return (
        <View style={{ flex: 1, backgroundColor: '#fff' }}>
            <View style={styles.headerRow}>
                ...
                <AppText variant="bold" style={styles.title}>Notifications for #{channelName}</AppText>
                <View style={{ width: 24 }} />
            </View>
                    ...
                    <>
                        ...
                        <View style={styles.buttonRow}>
                            ...
                            <TouchableOpacity style={styles.saveButton} onPress={handleSave} disabled={loading}>
                                {loading ? <ActivityIndicator color="#fff" /> : <AppText style={styles.saveText}>Save Changes</AppText>}
                            </TouchableOpacity>
                        </View>
                    </>
                )}
