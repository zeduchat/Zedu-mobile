...
const ChangePasswordScreen = ({ navigation }: any) => {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            dispatch({ type: ACTIONS.ERROR, payload: "An unexpected error occurred" });
        } finally {
            setIsSaving(false);
        }
    };

    const isFormValid = passwords.oldPassword && passwords.newPassword && passwords.confirmPassword;
        ...
        <Container>
            <View style={styles.header}>
                <TouchableOpacity onPress={() => navigation.goBack()} style={styles.backBtn}>
                    ...
                    <AppText variant="bold" style={styles.headerTitle}>Update password</AppText>
                </TouchableOpacity>
            </View>
            ...
            >
                ...
                <View style={styles.bottomActions}>
                        ...
                        >
                            {isSaving && <ActivityIndicator size="small" color="#FFFFFF" style={{ marginRight: 8 }} />}
...
const styles = StyleSheet.create({
    ...
    scrollContent: { paddingHorizontal: 20, paddingBottom: 20, paddingTop: 20, flexGrow: 1 },
