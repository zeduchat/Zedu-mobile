...
const BillingDetailsScreen = ({ route, navigation }: any) => {
    ...
    const isCurrentPlan = orgData?.organisation_plan?.plan_details?.id === plan.id;
        ...
        <Container>
            <View style={styles.header}>
                <TouchableOpacity onPress={() => navigation.goBack()} style={styles.backBtn}>
                    <Ionicons name="chevron-back" size={28} color="#000" />
                    <AppText variant="bold" style={styles.headerTitle}>Plan Details</AppText>
                </TouchableOpacity>
                <View style={{ width: 28 }} />
            </View>
            ...
            <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                <View style={styles.detailCard}>
                                ...
                                <View style={styles.row}>
                                    ...
                                    {isCurrentPlan && (
                                        <View style={styles.badge}>
                                            <AppText size={10} variant="bold" style={styles.badgeText}>Current plan</AppText>
                                        </View>
                                    )}
                                </View>
                    ...
                    <View style={styles.priceSection}>
                        ...
                        <AppText style={styles.creditsText}>{plan.credits} AI Credits included</AppText>
                    </View>

                    <View style={styles.featureBox}>
                        <View style={styles.featureTitleBg}>
                            <AppText variant="bold" size={13} style={{ color: '#374151' }}>What's included:</AppText>
                        </View>
                ...
                <TouchableOpacity
                    ...
                    onPress={() => Linking.openURL(`${CLIENT_URL || 'https://zedu.chat'}/contact`)}
                >
                    <AppText variant="bold" style={styles.outlineBtnText}>Contact Sales</AppText>
                </TouchableOpacity>
            </ScrollView>
        </Container>
    );
...
const styles = StyleSheet.create({
    ...
    perMonth: { fontSize: 16, color: '#6B7280', marginLeft: 4, marginBottom: 4, alignSelf: 'flex-end' },
    creditsText: { fontSize: 14, color: '#7165E3', marginTop: 4, fontWeight: '500' },
    featureBox: {
        padding: 20,
