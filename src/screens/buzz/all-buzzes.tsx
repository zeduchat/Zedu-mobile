...
const AllBuzzesScreen = () => {
    ...
    const renderItem = ({ item }: { item: OrgBuzz }) => <BuzzListItem buzz={item} />;
    ...
    const renderEmpty = () => {
        ...
        if (error) {
            return (
                <View style={styles.emptyWrap}>
                    <AppText size={13} style={styles.emptyText}>{error}</AppText>
                </View>
            );
        }
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={[styles.header, { paddingTop: headerTopPadding }]}>
                ...
                <AppText variant="bold" style={styles.headerTitle}>All Buzzes</AppText>
