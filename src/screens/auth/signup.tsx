    ...
    return (
        <Container>
            ...
            >
                ...
                <AppText variant="bold" size={23} style={styles.title}>Create an Account</AppText>
                ...
                {accountType === 'Organization' ? (
                            ...
                            <Dropdown
                                ...
                                renderRightIcon={() => (
                                    <Image
                                        ...
                                        style={[styles.chevron, { tintColor: isFocus ? Colors.primary : Colors.textSecondary }]}
                                    />
                                )}
                            />
                        </View>
                    ...
                    <View key="ind-form">
                                ...
                                <TouchableOpacity style={styles.socialBtn} onPress={handleGoogleLogin} disabled={googleLoading}>
                                    ...
                                    <AppText variant="medium" size={16}>Sign up with Google</AppText>
                                </TouchableOpacity>
                                {Platform.OS === 'ios' && (
                                    <TouchableOpacity style={styles.socialBtn} onPress={handleAppleLogin} disabled={appleLoading}>
                                        <Image source={require('@/assets/icons/apple.png')} style={styles.socialIcon} />
                                        <AppText variant="medium" size={16}>Sign up with Apple</AppText>
                        ...
                        <View style={styles.dividerContainer}>
                            ...
                            <AppText size={14} style={styles.orText}>OR</AppText>
                            <View style={styles.line} />
                        </View>
                ...
                <View style={styles.footer}>
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate('Signin')}>
                        <AppText variant="medium" style={styles.loginLink}>Log in</AppText>
                    </TouchableOpacity>
                </View>
            </KeyboardAwareScrollView>
        </Container>
...
const styles = StyleSheet.create({
    ...
    header: { alignItems: 'center', marginTop: normalize(20), flexDirection: 'row', justifyContent: 'center' },
    logo: { width: normalize(100), height: normalize(100), marginRight: normalize(8) },
    brandText: { color: Colors.black },
    title: { textAlign: 'center', marginTop: normalize(30), marginBottom: normalize(25), color: Colors.black },
    tabContainer: {
        flexDirection: 'row',
    ...
    tab: { flex: 1, paddingVertical: normalize(12), alignItems: 'center', borderRadius: normalize(8) },
    ...
    dividerContainer: { flexDirection: 'row', alignItems: 'center', marginVertical: normalize(20) },
    line: { flex: 1, height: 1, backgroundColor: Colors.border },
    orText: { marginHorizontal: 10, color: Colors.textSecondary },
    submitBtn: { marginTop: normalize(10) },
    footer: { flexDirection: 'row', justifyContent: 'center', marginTop: normalize(25) },
