    ...
    return (
        <Container>
            ...
            >
                ...
                <AppText variant="bold" size={23} style={styles.title}>Login to Zedu</AppText>

                {/* Social Login Buttons */}

                <TouchableOpacity style={styles.socialBtn} activeOpacity={0.8} onPress={handleGoogleLogin} disabled={googleLoading}>
                    <Image source={require('@/assets/google-icon.png')} style={styles.socialIcon} />
                    <AppText variant="medium" size={16}>Sign in with Google</AppText>
                    {googleLoading && <ActivityIndicator />}
                </TouchableOpacity>
                {Platform.OS === 'ios' && (
                    <TouchableOpacity style={styles.socialBtn} activeOpacity={0.8} onPress={handleAppleLogin} disabled={appleLoading}>
                        <Image source={require('@/assets/icons/apple.png')} style={styles.socialIcon} />
                        <AppText variant="medium" size={16}>Sign in with Apple</AppText>
                ...
                <View style={styles.footer}>
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate('Signup')}>
                        <AppText variant="medium" style={styles.signupLink}>Sign Up</AppText>
                    </TouchableOpacity>
                </View>
