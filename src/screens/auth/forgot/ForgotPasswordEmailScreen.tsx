...
const ForgotPasswordEmailScreen: React.FC = () => {
    ...
    const handleSubmit = async () => {
        ...
        if(!error){
            dispatch({type:ACTIONS.AUTH_FLOW, payload: {email: email, code: ""}})
    ...
    return (
        <Container>
            ...
            >
                ...
                <AppText variant="bold" size={23} style={styles.title}>Forgot password</AppText>
                <AppText size={18} style={styles.subtitle}>
                    Enter the email you used in creating your account, we will send you instructions on how to reset your password.
                </AppText>
