...
const ChannelOnboardingSheet = forwardRef<AppBottomSheetRef, {}>((props, ref) => {
        ...
        <View style={styles.container}>
            ...
            <View style={styles.content}>
                ...
                <AppText style={styles.description}>
                    Channels are a one-to-many space where you can share updates with an unlimited audience.
                </AppText>
            </View>
