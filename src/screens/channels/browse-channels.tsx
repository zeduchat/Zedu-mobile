...
const BrowseChannel = () => {
    ...
    const { channels, loading, loadingMore, refresh, loadMore } = useBrowseChannels(orgId, search); 
                                ...
                                <TouchableOpacity style={styles.chatItem} onPress={() => handleNavigate(item)}>
                                    ...
                                    <View style={styles.chatInfo}>
                                        <View style={styles.chatHeaderRow}>
                                            ...
                                            <AppText size={12} style={styles.chatTime}>{moment(item.created_at).format("h:mm a")}</AppText>
                                        </View>

                                        <AppText size={12} style={styles.chatTime}>{`${item.members_count} ${item.members_count > 1 ? "members" : "member"} in channel`}</AppText>
                                    </View>
                                </TouchableOpacity>
                            )}
