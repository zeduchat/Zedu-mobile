...
import {
    StyleSheet, View, TouchableOpacity, ScrollView, StatusBar,
    TextInput,
    ActivityIndicator
} from 'react-native';
...
const CreateChannelScreen = ({ navigation }: any) => {
    ...
    const createChannel = async () => {
        ...
        if (!error) {
            ...
            dispatch({type:ACTIONS.ERROR, payload: error || "An error occurred while creating channel"})
        }
        ...
        <Container>
            <View style={styles.header}>
                <TouchableOpacity onPress={() => navigation.goBack()} style={styles.headerBtn}>
                    ...
                    <AppText style={{ color: Colors.primary, fontSize: 17, marginLeft: -4 }}>Back</AppText>
                </TouchableOpacity>

                <AppText variant="bold" style={{ fontSize: 17, color: '#000' }}>Create New Channel</AppText>
            ...
            <ScrollView contentContainerStyle={styles.scrollContent} bounces={false}>
                    ...
                    <View style={[
                        ...
                        <TouchableOpacity style={styles.avatarPicker}>
                            <View style={styles.hashCircle}>
                                <AppText variant="bold" style={{ color: '#54656F', fontSize: 20 }}>#</AppText>
                            </View>
                        </TouchableOpacity>
                        <View style={{ flex: 1 }}>
                            <TextInput
                ...
                <View style={[styles.inputCard, { padding: 10, backgroundColor: '#e4e7ecfb' }, isFocusedDescription && { borderColor: Colors.primary, borderWidth: 1.5 }]}>
                    <TextInput
                ...
                {/* Type Section */}
                <AppText variant="medium" size={13} style={styles.sectionLabel}>TYPE</AppText>
                <View style={styles.inputCard}>
                    <TouchableOpacity
                    ...
                    >
                        ...
                        {channelType === 'Public' && <Ionicons name="checkmark" size={20} color={Colors.primary} />}
                    </TouchableOpacity>
                    ...
                    >
                        ...
                        {channelType === 'Private' && <Ionicons name="checkmark" size={20} color={Colors.primary} />}
                    </TouchableOpacity>
                </View>
                <AppText size={13} style={styles.helperText}>
