...
const AgentHome = () => {
    ...
    const { agents, loading, loadingMore, refresh, loadMore } = useOrgAgents(orgId, callback);
        ...
        <Container color={Colors.secondary} dark={true}>
            <View style={styles.topHeader}>
                <View style={styles.profileTop}>
                    ...
                    <TouchableOpacity style={styles.avatarContainer} onPress={() => navigation.navigate("SettingStack", { screen: "Profile" })}>
                        {user.avatar_url ?
                ...
                <View style={styles.searchBar}>
                    ...
                    <TextInput placeholder="Find an agent" placeholderTextColor={Colors.white} style={styles.searchInput} />
                </View>
            </View>
                                            ...
                                            <TouchableOpacity style={styles.agentItem}>
                                                <View style={styles.avatarPlaceholder}>
                                                    {item.avatar ?
                                                        ...
                                                        :
                                                        <Image source={require('@/assets/images/agent-avatar.png')} style={styles.avatarImg} />
                                                    }
                                                </View>
                                                <View style={styles.agentInfo}>
                                                    <View style={styles.agentHeader}>
                                                        <AppText variant="bold" style={styles.agentName}>{item.name}</AppText>
                                                        {item.thread_count > 0 &&
                                                            <View style={styles.countBadge}>
                                                                <AppText size={12} variant="bold" style={styles.countText}>{item.thread_count}</AppText>
                                                            </View>}
                                                    </View>
...
const styles = StyleSheet.create({
    ...
    agentItem: { flexDirection: 'row', marginBottom: normalize(25), alignItems: 'center' },
    avatarPlaceholder: {
    ...
    agentDesc: { fontSize: normalize(14), color: '#8E8E93', marginTop: 2, lineHeight: 20 },
