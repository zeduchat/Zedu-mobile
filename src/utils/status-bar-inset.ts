...
export function statusBarTopPadding(insetsTop: number, iosPadding = 40): number {
...
export function navigationBarBottomPadding(insetsBottom: number, fallback = 0): number {
