...
export type AndroidIncomingCallAction = Extract<NativeIncomingCallAction, 'open' | 'accept' | 'decline'>;
...
const NativeIncomingCall = NativeModules.IncomingCallAndroid as IncomingCallAndroidModule | undefined;
...
const normalizeEvent = (event: AndroidIncomingCallEvent | null): AndroidIncomingCallEvent | null => {
...
export const getAndroidLaunchIncomingCall = async (): Promise<AndroidIncomingCallEvent | null> => {
...
export const dismissAndroidIncomingCallNotification = async (): Promise<void> => {
...
export const subscribeToAndroidIncomingCalls = (
    ...
    const subscription = emitter.addListener('IncomingDirectCallAndroid', (payload) => {
